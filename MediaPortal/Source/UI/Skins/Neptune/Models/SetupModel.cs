...
namespace MediaPortal.UiComponents.Neptune.Models
{
  public class SetupModel : IWorkflowModel
  {
    ...
    public const string SETUP_MODEL_ID_STR = "7E252D7F-0ACD-46D1-9BCE-436B12110537";
    ...
    public void SaveSettings()
    {
      ...
      {
        string.Format("Plugins\\Neptune\\Skin\\Neptune\\Themes\\{0}\\Images\\{1}", skinSettings.Theme, SPLASH_SCREEN_NAME),
        string.Format("Plugins\\Neptune\\Skin\\Neptune\\Images\\{0}", SPLASH_SCREEN_NAME),
      };
